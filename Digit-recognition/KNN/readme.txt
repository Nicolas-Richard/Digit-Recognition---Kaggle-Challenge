...
I run the classifier on the whole set and submit to Kaggle : result a score of 0.96643 (rank 345, move up 35 positions!). Not huge but it's a start.
...
In conclusion, it seems like the best choice of option would be :  weights = 'distance', n_neighbors=10, p=3

As for the timing I have to say I don't think I can reach any conclusion for now.

%%% run it and score on Kaggle ?


Other things to try : 
1. feature reduction, through PCA for example
